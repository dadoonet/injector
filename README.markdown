...
This injector is used for Workshops or Demos about
...
```sh
java -jar injector-7.0.jar --nb 1000 --bulk 100
```
...
```sh
java -jar injector-7.0.jar --elasticsearch --es.host https://cloud_id.europe-west1.gcp.cloud.es.io:9243
```
...
```sh
java -jar injector-7.0.jar --elasticsearch --es.user elastic --es.pass changeme
```
...
```sh
java -jar injector-7.0.jar --elasticsearch --es.index person
```
...
```sh
java -jar injector-7.0.jar --appsearch --ap.host host-XYZ --app.key private-XYZ
```
...
```sh
java -jar injector-7.0.jar --appsearch --ap.host host-XYZ --app.key private-XYZ --ap.engine person
```
...
```sh
java -jar injector-7.0.jar --console --cs.pretty
```
...
```sh
java -jar injector-7.0.jar --console --cs.appsearch
```
...
Just get the final jar from `target/injector-7.0.jar`. Or:
